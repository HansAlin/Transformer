...
class BilingualDataset(torch.utils.data.Dataset):
  def __init__(self, ds, tokenizer_src, tokenizer_tgt , src_lang, tgt_lang, seq_len=128):
    super().__init__()
  ...
  def __getitem__(self, index: Any) -> Any:
    ...
    return {
            ...
            "decoder_mask": (decoder_input != self.pad_token).unsqueeze(0).unsqueeze(0) & causual_mask(decoder_input.size()), # (1, seq_len) @ (1, seq_len, seq_len) 
